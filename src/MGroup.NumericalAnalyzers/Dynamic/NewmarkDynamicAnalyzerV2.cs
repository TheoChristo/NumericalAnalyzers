...
{
	public class NewmarkDynamicAnalyzerV2 : INonLinearParentAnalyzer, IStepwiseAnalyzer
	{
		...
		private NewmarkDynamicAnalyzerV2(IAlgebraicModel algebraicModel, ITransientAnalysisProvider provider,
		...
		public class Builder
		{
			...
			public NewmarkDynamicAnalyzerV2 Build()
				=> new NewmarkDynamicAnalyzerV2(algebraicModel, provider, childAnalyzer, timeStep, totalTime, beta, gamma, currentStep, calculateInitialDerivativeVectors);
		}
	}
}
